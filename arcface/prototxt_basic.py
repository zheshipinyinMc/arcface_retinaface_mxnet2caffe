...
names_output = {"rf_c2_upsampling":64 ,"rf_c3_upsampling":64} #retinaface mnet.25
#names_output = {"ssh_m2_red_up":32,"ssh_c3_up":32 } #retinaface R50
...
def write_node(txt_file, info):
    ...
    elif info['op'] == 'UpSampling':  #The Deconvolution channels need to be set (in prototxt_basic.py names_output).
